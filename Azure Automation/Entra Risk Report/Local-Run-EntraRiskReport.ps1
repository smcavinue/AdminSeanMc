<#
    .SYNOPSIS
        ...
        It will then format the results into an HTML report and send it via email. This is the local version of the script that can be run on a local machine.
    ...
    .EXAMPLE
        ...
        .\local-Run-EntraRiskReport.ps1

    .NOTES
        NAME:    local-Run-EntraRiskReport.ps1

#>

##Define email values
$sender = "adminsmc@contoso.com"
$recipient = "adminsmc@contoso.com"
$subject = "Daily Risk Report"

Connect-MgGraph -Scopes "IdentityRiskyUser.Read.All","IdentityRiskEvent.Read.All","IdentityRiskyServicePrincipal.Read.All","Mail.Send"
